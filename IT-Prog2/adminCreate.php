...
if(isset($_POST['register'])){
	...
	if(!isset($_POST['secret']) || $_POST['secret'] !== 'mySuperSecretKey123') {
    ...
    // Insert as admin
    $sql = "INSERT INTO users(firstname, lastname, email_address, username, password, role, created_at)
            VALUES('$firstname', '$lastname', '$email', '$username', '$hashed_password', 'admin', NOW())";

    $result = mysqli_query($con, $sql);

    if($result){
        $_SESSION['message'] = "Admin Account Created Successfully";
        // You can redirect to login or just show a success message
