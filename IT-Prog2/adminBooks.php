...
if (isset($_POST['add_book'])) {
    ...
    $sql = "INSERT INTO books (title, author, year, category, quantity) VALUES ('$title', '$author', '$year', '$category', $quantity)";
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="booksTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $books_q = mysqli_query($con, "SELECT * FROM books");
                            while ($b = mysqli_fetch_assoc($books_q)) {
                                echo "<tr>
                                    ...
                                    <td>{$b['category']}</td>
                                    <td>{$b['quantity']}</td>
                                    <td><a href='#' class='btn btn-danger btn-sm' data-id='{$b['id']}' onclick='confirmDelete({$b['id']})'>Delete</a></td>
                                </tr>";
                            }
                            ?>
                        </tbody>
